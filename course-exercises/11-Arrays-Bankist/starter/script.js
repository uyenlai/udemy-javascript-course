...
Eating too much means the dog's current food portion is larger than the recommended portion, and eating too little is the 
opposite.
...
current > (recommended * 0.90) && current < (recommended * 1.10). Basically, the current portion should be between 
...
//2
// const sarahName = dogs.flatMap(dog => dog.owners).find(word => word.startsWith('Sa'))
// console.log(sarahName);
// const sarahIndex = dogs.findIndex(dog =>
//   dog.owners.includes(
//     dogs.flatMap(dog => dog.owners).find(word => word.startsWith('Sa'))
//   )
// );
// console.log(sarahIndex);
// const sarahDog = dogs[sarahIndex];
...
//3
const ownersEatTooMuch = dogs.filter(dog => dog.curFood > dog.portion).flatMap(dog => dog.owners)
console.log(ownersEatTooMuch);
const ownersEatTooLittle = dogs.filter(dog => dog.curFood < dog.portion).flatMap(dog => dog.owners)
...
//6
console.log(dogs.some(dog => dog.curFood > dog.portion * 0.9 && dog.curFood < dog.portion * 1.1));

//7
console.log(dogs.filter(dog => dog.curFood > dog.portion * 0.9 && dog.curFood < dog.portion * 1.1));

//8
console.log(dogs.slice().sort((a, b) => a.portion - b.portion));
