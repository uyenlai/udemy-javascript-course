...
2. Implement an 'accelerate' method that will increase the car's speed by 10, and log the new speed 
to the console;
3. Implement a 'brake' method that will decrease the car's speed by 5, and log the new speed to the 
console;
...
/* 
  ...
  Besides a make and current speed, the EV also has the current battery charge in % 
  ('charge' property);
...
class EVCl extends CarCl {
  ...
  accelerate() {
    this.speed += 20
    this.#charge--
    console.log(`${this.make} is going ar ${this.speed} km/h, with a charge of ${this.#charge}`);
    return this
  }
}
